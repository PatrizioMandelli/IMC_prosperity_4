...
"""
GALAXY_SOUNDS Strategy: Cross-Cluster Statistical Arbitrage
Edge: Cointegration and strong correlations between GALAXY products and external oracles.
- BLACK_HOLES tracks PEBBLES_S (inverse).
- DARK_MATTER tracks UV_VISOR_YELLOW.
- PLANETARY_RINGS tracks DARK_MATTER.
- SOLAR_WINDS tracks PANEL_1X4.
- SOLAR_FLAMES tracks SOLAR_WINDS.

Execution: Hybrid aggressive market-taking (when edge > 1.0 std) and passive market-making inside the spread.
Position Limits: ±10 per product.
"""
...
class Trader:
    def __init__(self):
        ...
        # Internal limit to satisfy "Mean Absolute Position < 8" criteria
        self.pos_limit = 8 
